...
Once implementation reached this point in production Go problems were created from scratch or re-created from external sources such as [3][4][16]. This was done to first test and evaluate GoLD and then to produce a folder of problems which could be solved by the computer to be packaged along with the final version of GoLD.
