...
public class BentThreev2Old {
	Evaluator e;
	PatternSearcher ps;

	public BentThreev2Old (Evaluator e){
		this.e=e;
	}
...
//					if(e.isThere(S0) || e.isThere(S2))continue;
					...
					if(e.isTheres(S1,LT,TL)) retval+=500;
					else if(e.isTheres(S1,LB,TR))retval+=1000;
					else if(e.isTheres(S1,LT,TR))retval+=1000;
					else if(e.isTheres(S1,LB,TL))retval+=1000;
