...
//			
//					
//					if(e.isEnemy(TL) || e.isEnemy(TR) || e.isEnemy(S0) || e.isEnemy(S1) || e.isEnemy(S2)) {
//						if(e.isEnemies(TL)) {
//							retval-=400;
//							if(e.isEnemies(TL,TR)) {
//								retval-=50;
//								if(e.isEnemies(TL,TR,S0)) {
//									retval-=100;
//									if(e.isEnemies(TL,TR,S1,S0)) retval-=50;
//									else if(e.isEnemies(TL,TR,S2,S0)) retval+=50;
//								}else if(e.isEnemies(TL,TR,S1)) {
//									retval-=50;
//									if(e.isEnemies(TL,TR,S1,S2)) retval+=100;
//								}else if(e.isEnemies(TL,TR,S2)) retval-=0;
//								else if(e.isThere(S1)) retval-=150;
//							}else if(e.isEnemies(TL,S0)) {
//								retval-=50;
//								if(e.isEnemies(TL,S0,S1)) {
//									retval-=50;
//									if(e.isThere(TR)) retval+=100;
//								}else if(e.isEnemies(TL,S0,S2)) {
//									retval+=400;
//									if(e.isThere(TR)) retval+=450;
//								}else if(e.isThere(TR)) retval+=450;
//							}else if(e.isEnemies(TL,S1)) {
//								if(e.isEnemies(TL,S1,S2)) retval-=0;
//							}else if(e.isEnemies(TL,S2)) {
//								 if(e.isThere(TR)) retval+=400;
//							}else if(e.isThere(S1)) {
//								retval+=200;
//								if(e.isThere(TR))retval+=400;
//							}else if(e.isThere(TR)) retval+=400;
//						}else if(e.isEnemies(TR)) {
//							retval-=400;
//							if(e.isEnemies(TR,S0)) {
//								retval-=50;
//								if(e.isEnemies(TR,S0,S1)) retval-=100;
//								else if(e.isEnemies(TR,S0,S2)) retval+=350;
//								else if(e.isThere(TL)) retval+=450;
//							}else if(e.isEnemies(TR,S1)) {
//								retval-=0;
//								if(e.isEnemies(TR,S1,S2)) retval-=0;
//							}else if(e.isEnemies(TR,S2)) {
//								retval-=0;
...
//							retval-=0;
//							if(e.isEnemies(S0,S1)) retval-=400;
//							else if(e.isEnemies(S0,S2)) retval+=400;
