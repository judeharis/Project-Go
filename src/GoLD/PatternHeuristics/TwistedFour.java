		...
		if(!pMatches.isEmpty()) {
			...
			for(ArrayList<Tuple> tlist: pMatches) {
				if(!tlist.isEmpty()) {
					...
					int patval =0;	
					patval +=50;
					float z1 = States.borderSafeRel1(e, 6,RB,TR,LT,BL,S1,D1);
					...
					patval +=650;
					float b1 = States.borderSafeRel2(e, 2, LT,BL);
					float b2 = States.borderSafeRel2(e, 2, TR,RB);
					float b3 = States.borderSafeRel2(e, 2, S0,D0);
					float b4 = States.borderSafeRel2(e, 3, D0,BR,LT);
					float b5 = States.borderSafeRel2(e, 3, D0,BR,BL);
					float b6 = States.borderSafeRel2(e, 3, S0,TL,TR);
					float b7 = States.borderSafeRel2(e, 3, S0,TL,RB);
